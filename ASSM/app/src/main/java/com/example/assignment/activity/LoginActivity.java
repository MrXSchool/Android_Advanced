    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        checkBox.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                editor.apply();
                Toast.makeText(LoginActivity.this, "Đã lưu trạng thái", Toast.LENGTH_SHORT).show();
            }
        });

        boolean rememberMe = sharedPreferences.getBoolean("rememberMe", false);
        if (rememberMe) {
            // Đọc thông tin đăng nhập từ SharedPreferences và điền vào EditText
            String savedUsername = sharedPreferences.getString("username", "");
            String savedPassword = sharedPreferences.getString("password", "");
            Log.d("TAG>>>>>>>>", "onCreate: "+savedUsername+" "+savedPassword+" "+rememberMe);
...
//                                            null, 0, 0, 0);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (rememberMe) {
                    ...
                    // Xóa thông tin đăng nhập trong SharedPreferences nếu checkbox không được check
    ...
    private final BroadcastReceiver MyRe1 = new BroadcastReceiver() {
        @Override
