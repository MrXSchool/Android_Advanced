...
public class MXHAcitivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mxhacitivity);
        ...
        btnShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra(Intent.EXTRA_SUBJECT, "MrX chia sẻ");
    ...
    private Uri getmageToShare(Bitmap bitmap) {
        ...
        try {
            ...
            outputStream.flush();
            outputStream.close();
            uri = FileProvider.getUriForFile(this, "com.example.assignment.fileprovider", file);
        } catch (Exception e) {
